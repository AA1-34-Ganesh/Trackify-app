...
- **money-tracker.html**: The main page for tracking expenses.
- **script.js**: Contains the JavaScript code for handling user interactions and updating the expense list.
